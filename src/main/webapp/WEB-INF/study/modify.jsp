...
<div id="container">
    ...
    <h1 style="width: 75%; margin: 0 auto 20px; text-align: center;">나의 학습 수정</h1>
    <form name="frmModify" id="frmModify" method="post" action="/study/modify" enctype="multipart/form-data">
        <div class="list-group w1024" style="margin: 0 auto;">
            ...
            <div class="mb-5">
                ...
                <button type="button" class="btn btn-outline-danger btn-sm" onclick="location.href='/study/list'">수정취소</button>
            </div>
        </div>
    </form>
