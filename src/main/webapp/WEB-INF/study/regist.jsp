...
<div class="container-fluid">
    ...
    <h1 style="width: 75%; margin: 0 auto 20px; text-align: center;">Regist</h1>
                    ...
                    <div class="mb-1">
                        <div class="mb-3" >
                            <div class="input-group">
                                ...
                                <input type="text" name="user_id" id="user_id" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="${loginInfo}" maxlength="20" readonly>
                            </div>
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control" name="display_date" id="display_date" value="${bbsDTO.display_date}" maxlength="10" />
                            </div>
